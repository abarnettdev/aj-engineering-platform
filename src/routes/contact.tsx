  ...
  head: () => ({
    meta: [
      { title: "Contact · AJ Barnett" },
      {
        name: "description",
        content:
          "Senior, Staff, or Principal Software Engineering and AI Automation Engineering roles at teams building real products for real users, using AI as leverage, not as a shortcut.",
      },
      { property: "og:title", content: "Contact · AJ Barnett" },
      {
        property: "og:description",
        content:
          "Open to Senior / Staff / Principal roles. Judgment stays human. Execution accelerates.",
      },
  ...
  return (
    <>
      <PageHero
        ...
        description={
          <>
            Senior, Staff, or Principal Software Engineering and AI
            Automation Engineering roles at teams shipping real products for
            real users. Judgment stays human. Execution accelerates.
          </>
        }
