import{t as e}from"./jsx-runtime-B4XW9ad0.js";import{fn as t}from"./dist-Ccw_2GY5.js";import{n,t as r}from"./contact-contracts-C1lpEsi3.js";var i=e(),a={title:`Features/Ask A.J./Contact Form`,component:n,parameters:{layout:`centered`},argTypes:{state:{control:`select`,options:[`idle`,`submitting`,`success`,`error`]},error:{control:`text`},values:{control:`object`},errors:{control:`object`},onChange:{action:`field changed`},onSubmit:{action:`submitted`}},args:{values:r,errors:{},state:`idle`,onChange:t(),onSubmit:t()},decorators:[e=>(0,i.jsx)(`div`,{className:`w-[min(100vw-2rem,26rem)] border border-border bg-surface p-5`,children:(0,i.jsx)(e,{})})]},o={},s={args:{values:{...r,name:`Morgan Lee`,email:`morgan@example.com`,roleCompany:`Engineering recruiter, Northstar`,message:`I'd like to discuss a senior engineering role.
